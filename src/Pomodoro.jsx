...
class Time extends React.Component {
  ...
  render() {
    ...
    return (
      <div className="timer">
        <p className="timer__description">{activeTimer}</p> <br/>
